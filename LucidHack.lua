...
//Variables
local LucidHack = {}
LucidHack.FriendsList = {}
LucidHack.TextEntries = {}
LucidHack.Hooks = {}
LucidHack.EntityESP = {}
LucidHack.BoneOrder = {}
LucidHack.Traitors = {}
...
LucidHack.Options["Aimbot_Toggle"] = false
LucidHack.Options["Aimbot_LOSCheck"] = false
LucidHack.Options["Aimbot_AutoWall"] = true
LucidHack.Options["Aimbot_AimOnKey"] = false
LucidHack.Options["Aimbot_AimOnKey_Key"] = 0
LucidHack.Options["Aimbot_SmoothAim"] = false
LucidHack.Options["Aimbot_SmoothAim_Value"] = 600
LucidHack.Options["Aimbot_AimPriority"] = "Distance"
LucidHack.Options["Aimbot_FOV"] = false
if LocalPlayer():GetFOV() != nil then LucidHack.Options["Aimbot_FOV_Value"] = LocalPlayer():GetFOV() else LucidHack.Options["Aimbot_FOV_Value"] = 75 end
LucidHack.Options["Aimbot_StickToTarget"] = false
LucidHack.Options["Aimbot_BoneAim"] = false
LucidHack.Options["Aimbot_AutoShoot"] = false

LucidHack.Options["Aimbot_AimTeam"] = false
LucidHack.Options["Aimbot_AimOpponents"] = true
LucidHack.Options["Aimbot_AimFriends"] = false
LucidHack.Options["Aimbot_AimEnemies"] = false
LucidHack.Options["Aimbot_AimNPCs"] = false
LucidHack.Options["Aimbot_AimSpectators"] = false
LucidHack.Options["Aimbot_AimTeamV"] = "Aim"
LucidHack.Options["Aimbot_AimOpponentsV"] = "Aim"
LucidHack.Options["Aimbot_AimFriendsV"] = "Aim"
LucidHack.Options["Aimbot_AimEnemiesV"] = "Aim"
LucidHack.Options["Aimbot_AimNPCsV"] = "Aim"
LucidHack.Options["Aimbot_AimSpectatorsV"] = "Aim"

LucidHack.Options["Aimbot_OffsetX"] = 0
LucidHack.Options["Aimbot_OffsetY"] = 0

LucidHack.Options["ESP_Toggle"] = false
LucidHack.Options["ESP_ShowTeam"] = true
LucidHack.Options["ESP_ShowOpponents"] = true
LucidHack.Options["ESP_ShowFriends"] = false
LucidHack.Options["ESP_ShowEnemies"] = false
LucidHack.Options["ESP_ShowNPCs"] = false
LucidHack.Options["ESP_ShowSpectators"] = false

LucidHack.Options["ESP_ShowTeamV"] = "Show"
LucidHack.Options["ESP_ShowOpponentsV"] = "Show"
LucidHack.Options["ESP_ShowFriendsV"] = "Show"
LucidHack.Options["ESP_ShowEnemiesV"] = "Show"
LucidHack.Options["ESP_ShowNPCsV"] = "Show"
LucidHack.Options["ESP_ShowSpectatorsV"] = "Show"

LucidHack.Options["ESP_Entity_Toggle"] = false
LucidHack.Options["ESP_Entities_NameTags"] = false
LucidHack.Options["ESP_Entities_BoundaryBoxes"] = false
LucidHack.Options["ESP_Entities_BoundaryBoxes_Mode"] = "2D"

LucidHack.Options["ESP_BoundaryBoxes"] = false
LucidHack.Options["ESP_BoundaryBoxes_Mode"] = "2D"
LucidHack.Options["ESP_NameTags"] = false
LucidHack.Options["ESP_Weapon"] = false
LucidHack.Options["ESP_Distance"] = false
LucidHack.Options["ESP_Health"] = false
LucidHack.Options["ESP_Skeleton"] = false
LucidHack.Options["ESP_Crosshair"] = false
LucidHack.Options["ESP_Crosshair_Size"] = 50
LucidHack.Options["ESP_Crosshair_Mode"] = "Team"
LucidHack.Options["ESP_Crosshair_Color_R"] = 0
LucidHack.Options["ESP_Crosshair_Color_G"] = 0
LucidHack.Options["ESP_Crosshair_Color_B"] = 255
LucidHack.Options["ESP_Crosshair_Color_A"] = 255

LucidHack.Options["Misc_Clock"] = false
LucidHack.Options["Misc_Clock_Mode"] = "Fast"
if GetConVarNumber("host_timescale") != nil then LucidHack.Options["Misc_Clock_Speed"] = GetConVarNumber("host_timescale") else LucidHack.Options["Misc_Clock_Speed"] = 1 end
LucidHack.Options["Misc_AdminBox"] = false
LucidHack.Options["Misc_AdminBox_Mode"] = "Auto"
LucidHack.Options["Misc_AdminBox_PosX"] = 0
LucidHack.Options["Misc_AdminBox_PosY"] = 0
LucidHack.Options["Misc_SpectatorsBox"] = false
LucidHack.Options["Misc_SpectatorsBox_Mode"] = "Auto"
LucidHack.Options["Misc_SpectatorsBox_PosX"] = 150
LucidHack.Options["Misc_SpectatorsBox_PosY"] = 0
LucidHack.Options["Misc_AutoButton"] = false

LucidHack.Options["Friends_FriendIsEnemy"] = false
LucidHack.Options["Friends_SteamFriends"] = false
LucidHack.Options["Friends_SteamEnemies"] = false

LucidHack.Options["Cams_Toggle"] = false
LucidHack.Options["Cams_CSNoclip"] = false
LucidHack.Options["Cams_CSNoclip_Speed"] = 10
LucidHack.Options["Cams_ThirdPerson"] = false
LucidHack.Options["Cams_ThirdPerson_Zoom"] = 30

LucidHack.Options["Bhop_Toggle"] = false
LucidHack.Options["Bhop_FastWalk"] = false
LucidHack.Options["Bhop_AutoHop"] = false
LucidHack.Options["Bhop_AutoStrafe"] = false
LucidHack.Options["Bhop_EdgeJump"] = false
LucidHack.Options["Bhop_EdgeJump_Distance"] = 40
LucidHack.Options["Bhop_Sideways"] = false
LucidHack.Options["Bhop_WOnly"] = false

LucidHack.Options["Spam_Toggle"] = false
LucidHack.Options["Spam_Delay"] = false
LucidHack.Options["Spam_Delay_Value"] = 10
LucidHack.Options["Spam_AntiAntiSpam"] = false
LucidHack.Options["Spam_Message_1"] = false
LucidHack.Options["Spam_Message_2"] = false
LucidHack.Options["Spam_Message_3"] = false
LucidHack.Options["Spam_Message_4"] = false
LucidHack.Options["Spam_Message_5"] = false
...
function GetTeam( Ply )
	...
	if GMode == 1 then
		if Team == TEAM_SPECTATOR then
			...
			if table.HasValue(LucidHack.Traitors, Ply:SteamID()) then
				t = 1
				c = Color(255,0,0)
	...
	elseif GMode == 2 then
		if Team == TEAM_SPECTATOR then
			...
			if table.HasValue(LucidHack.Murderers, Ply:SteamID()) then
				t = 2
				c = Color(255,0,0)
			else
				t = 1
...
function UnloadLucidHack( Display )
	//Menu
	concommand.Remove("LucidHack_Menu")

	//Hooks
	LucidHack.Options["Misc_AdminBox"] = false
	LucidHack.Options["Misc_SpectatorsBox"] = false //These remove the admin/spectator boxes
	...
	timer.Simple( 0.5, function() 
		...
		if Display then
			AddHook( "Unloaded", "HUDPaint", RandomString(), function()
				draw.SimpleTextOutlined( "Lucid's Hack Unloaded Successfully!", "Menu_Title", ScrW()/2, 50, Color(0,150,150), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0,0,0) )
...
function ReloadLucidHack( Display )
	local Admin = LucidHack.Options["Misc_AdminBox"]
	local Spec = LucidHack.Options["Misc_SpectatorsBox"]
	UnloadLucidHack()
	timer.Simple( 0.5, function()
		LoadLucidHack()
		if Admin then
			LucidHack.Options["Misc_AdminBox"] = true
			AddDisplayBox( "Admins", 1 )
		end
		if Spec then
			LucidHack.Options["Misc_SpectatorsBox"] = true
			AddDisplayBox( "Spectators", 2 )
		end
		LocalPlayer():ConCommand("LucidHack_Menu")
		if Display then
			AddHook( "Reloaded", "HUDPaint", RandomString(), function()
				draw.SimpleTextOutlined( "Lucid's Hack Reloaded Successfully!", "Menu_Title", ScrW()/2, 50, Color(0,150,150), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0,0,0) )
				timer.Simple( 3, function()
					RemoveHook("Reloaded")
				end)
			end)
...
function LoadLucidHack( Display )
	//Commands
	CreateClientConVar("LucidHack_Panic", 0, false, false)
	concommand.Add("LucidHack_Menu", LucidHackMenu)
	...
	AddHook( "Menu", "Think", RandomString(), function()
		...
		//For Time Scale
		if LucidHack.Options["Misc_Clock"] && GetConVarNumber("LucidHack_Panic") == 0 then
			if GetConVarNumber("sv_cheats") != 1 then LocalPlayer():ConCommand("incrementvar sv_cheats 1 1 1") end
			if LucidHack.Options["Misc_Clock_Speed"] != ScaleNum || !ScaleActive || TimeScaleChange then
				local k
				if LucidHack.Options["Misc_Clock_Mode"] == "Slow" then k = 1-(LucidHack.Options["Misc_Clock_Speed"]/10) else k = LucidHack.Options["Misc_Clock_Speed"] end
		...
		elseif LucidHack.Options["Misc_Clock"] && GetConVarNumber("LucidHack_Panic") == 1 then
			if ScaleActive then
		...
		if GMode == 1 then
			if GetRoundState() != 3 then
				table.Empty(LucidHack.Traitors)
			else
				for k, v in pairs(player.GetAll()) do
					...
					if LocalPlayer():GetRole() != 1 then
						for k, v in pairs(Ply:GetWeapons()) do
							if table.HasValue(v.CanBuy, 1) && !table.HasValue(LucidHack.Traitors, Ply:SteamID()) then
								table.insert(LucidHack.Traitors, Ply:SteamID())
							end
						end
					else
						if Team == 1 && !table.HasValue(LucidHack.Traitors, Ply:SteamID()) then
							table.insert(LucidHack.Traitors, Ply:SteamID())
						end
					end
				end
			...
			if !MDone then
				for k, v in pairs(ents.GetAll()) do
					if v:GetClass() == "weapon_mu_knife" then
						table.insert(LucidHack.Murderers, v:GetOwner():SteamID())
					end
				end
				MDone = true
			else
				for k, v in pairs(ents.GetAll()) do
					if v:GetClass() == "weapon_mu_knife" then
						if !table.HasValue(LucidHack.Murderers, v:GetOwner():SteamID()) then
							table.Empty(LucidHack.Murderers)
							MDone = false
						end
					end
				end
	...
	AddHook( "Aimbot", "Think", RandomString(), function()
		if GetConVarNumber("LucidHack_Panic") == 0 && LucidHack.Options["Aimbot_Toggle"] && !MenuOpen && !(LucidHack.Options["Cams_Toggle"] && LucidHack.Options["Cams_CSNoclip"]) then
			if !LucidHack.Options["Aimbot_AimOnKey"] || ( ( ( LucidHack.Options["Aimbot_AimOnKey_Key"] >= 107 && LucidHack.Options["Aimbot_AimOnKey_Key"] <= 113 ) && input.IsMouseDown(LucidHack.Options["Aimbot_AimOnKey_Key"]) ) || input.IsKeyDown(LucidHack.Options["Aimbot_AimOnKey_Key"]) ) then
				local FinAngleP
				local AimSpotT = {}
				local PlayerDistance, NewPlayerDistance, MousePos, NewMousePos = math.huge, math.huge, math.huge, math.huge
				if !LucidHack.Options["Aimbot_StickToTarget"] then EntTable = ents.GetAll() end
				for k, v in pairs(EntTable) do
					if v != LocalPlayer() && v:IsValid() && v:Health() > 0 && ( v:IsNPC() || v:IsPlayer() ) then
						...
						if !Ent:IsNPC() then
							...
							if Ent:Team() != TEAM_SPECTATOR && LucidHack.Options["Aimbot_AimTeam"] && Team == GetTeam(LocalPlayer()) then
								if LucidHack.Options["Aimbot_AimTeamV"] == "Aim" then
									AimTeam = true
								else
									AimTeamV = false
								end
							end
							if Ent:Team() != TEAM_SPECTATOR && LucidHack.Options["Aimbot_AimOpponents"] && Team != GetTeam(LocalPlayer()) then
								if LucidHack.Options["Aimbot_AimOpponentsV"] == "Aim" then
									AimOpponents = true
								else
									AimOpponentsV = false
								end
							end
							if Ent:Team() != TEAM_SPECTATOR && LucidHack.Options["Aimbot_AimFriends"] && ( (!LucidHack.Options["Friends_FriendIsEnemy"] && table.HasValue( LucidHack.FriendsList, Ent:SteamID() ) ) || (LucidHack.Options["Friends_FriendIsEnemy"] && !table.HasValue( LucidHack.FriendsList, Ent:SteamID() ) ) ) then
								if LucidHack.Options["Aimbot_AimFriendsV"] == "Aim" then
									AimFriends = true
								else
									AimFriendsV = false
								end
							end
							if Ent:Team() != TEAM_SPECTATOR && LucidHack.Options["Aimbot_AimEnemies"] && ( (!LucidHack.Options["Friends_FriendIsEnemy"] && !table.HasValue( LucidHack.FriendsList, Ent:SteamID() ) ) || (LucidHack.Options["Friends_FriendIsEnemy"] && table.HasValue( LucidHack.FriendsList, Ent:SteamID() ) ) ) then
								if LucidHack.Options["Aimbot_AimEnemiesV"] == "Aim" then
									AimEnemies = true
								else
									AimEnemiesV = false
								end
							end
							if LucidHack.Options["Aimbot_AimSpectators"] && Ent:Team() == TEAM_SPECTATOR then
								if LucidHack.Options["AimSpectatorsV"] == "Aim" then
									AimSpectators = true
								else
							...
							if LucidHack.Options["Aimbot_AimNPCs"] && LucidHack.Options["Aimbot_AimNPCsV"] == "Aim" then
								if LucidHack.Options["Aimbot_AimNPCsV"] == "Aim" then
									AimNPCs = true
								else
									AimNPCsV = false
								end
						...
						if (AimTeam || AimOpponents || AimFriends || AimEnemies || AimSpectators || AimNPCs) && (AimTeamV && AimOpponentsV && AimFriendsV && AimEnemiesV && AimSpectatorsV && AimNPCsV) then
							...
							if LucidHack.Options["Aimbot_BoneAim"] && LucidHack.BoneOrder[1] != nil then
								table.Empty( AimSpotT )
								for k, v in pairs(LucidHack.BoneOrder) do
							...
							AimSpot = AimSpot+(CurAngle:Right()*LucidHack.Options["Aimbot_OffsetX"]) //This is screw up when close to your target
							AimSpot.z = AimSpot.z + LucidHack.Options["Aimbot_OffsetY"]
							...
							if LucidHack.Options["Aimbot_AimPriority"] == "Distance" then
							...
							elseif LucidHack.Options["Aimbot_AimPriority"] == "Crosshair" then
							...
							if LucidHack.Options["Aimbot_FOV"] then
								...
								if CalcX <= LucidHack.Options["Aimbot_FOV_Value"]/2 && CalcY <= LucidHack.Options["Aimbot_FOV_Value"]*0.4 then AimF = true end
							else
								AimF = true
							end

							if LucidHack.Options["Aimbot_LOSCheck"] || LucidHack.Options["Aimbot_AutoWall"] then
								for k, v in pairs(AimSpotT) do
									local TrLOS = {}
									TrLOS.start = LocalPlayer():GetShootPos()
									TrLOS.endpos = v
									TrLOS.filter = {}
									if LucidHack.Options["Aimbot_StickToTarget"] then
										for k, v in pairs(ents.GetAll()) do
									...
									if LucidHack.Options["Aimbot_AutoWall"] then TrLOS.mask = MASK_SHOT else TrLOS.mask = MASK_VISIBLE_AND_NPCS end
							...
							elseif LucidHack.Options["Aimbot_StickToTarget"] && EntTable[2] != nil then
				...
				if EntTable != nil && FinAngleP != nil then
					if LucidHack.Options["Aimbot_SmoothAim"] then
						SmoothAngles( FinAngleP, LucidHack.Options["Aimbot_SmoothAim_Value"] )
					else
						if LucidHack.Options["Aimbot_AutoShoot"] then
	...
	AddHook( "ChatSpam", "Think", RandomString(), function()
		if GetConVarNumber("LucidHack_Panic") == 0 then
			if !SpamWait then
				if LucidHack.Options["Spam_Toggle"] then
					if LucidHack.Options["Spam_Delay"] then
						SpamWait = true
						Spam1, Spam2, Spam3, Spam4, Spam5 = false, false, false, false, false
						local Timer = LucidHack.Options["Spam_Delay_Value"]
						if LucidHack.Options["Spam_Message_1"] && LucidHack.TextEntries["Spam1"] != nil then
							local String = LucidHack.TextEntries["Spam1"]
							if LucidHack.Options["Spam_AntiAntiSpam"] then String = String.." ("..RandomShortString()..")" end
							timer.Simple( Timer, function()
								LocalPlayer():ConCommand("say "..String)
								Spam1 = true
							end)
							Timer = Timer + LucidHack.Options["Spam_Delay_Value"]
						else Spam1 = true end

						if LucidHack.Options["Spam_Message_2"] && LucidHack.TextEntries["Spam2"] != nil then
							local String = LucidHack.TextEntries["Spam2"]
							if LucidHack.Options["Spam_AntiAntiSpam"] then String = String.." ("..RandomShortString()..")" end
							timer.Simple( Timer, function()
								LocalPlayer():ConCommand("say "..String)
								Spam2 = true
						...
						if LucidHack.Options["Spam_Message_3"] && LucidHack.TextEntries["Spam3"] != nil then
							local String = LucidHack.TextEntries["Spam3"]
							if LucidHack.Options["Spam_AntiAntiSpam"] then String = String.." ("..RandomShortString()..")" end
							timer.Simple( Timer, function()
								LocalPlayer():ConCommand("say "..String)
								Spam3 = true
						...
						if LucidHack.Options["Spam_Message_4"] && LucidHack.TextEntries["Spam4"] != nil then
							local String = LucidHack.TextEntries["Spam4"]
							if LucidHack.Options["Spam_AntiAntiSpam"] then String = String.." ("..RandomShortString()..")" end
							timer.Simple( Timer, function()
								LocalPlayer():ConCommand("say "..String)
								Spam4 = true
						...
						if LucidHack.Options["Spam_Message_5"] && LucidHack.TextEntries["Spam5"] != nil then
							local String = LucidHack.TextEntries["Spam5"]
							if LucidHack.Options["Spam_AntiAntiSpam"] then String = String.." ("..RandomShortString()..")" end
							timer.Simple( Timer, function()
								LocalPlayer():ConCommand("say "..String)
								Spam5 = true
						...
						if LucidHack.Options["Spam_Message_1"] && LucidHack.TextEntries["Spam2"] != nil then
							local String = LucidHack.TextEntries["Spam2"]
							if LucidHack.Options["Spam_AntiAntiSpam"] then String = String.." ("..RandomShortString()..")" end
							LocalPlayer():ConCommand("say "..String)
						end
						if LucidHack.Options["Spam_Message_1"] && LucidHack.TextEntries["Spam3"] != nil then
							local String = LucidHack.TextEntries["Spam3"]
							if LucidHack.Options["Spam_AntiAntiSpam"] then String = String.." ("..RandomShortString()..")" end
							LocalPlayer():ConCommand("say "..String)
						end
						if LucidHack.Options["Spam_Message_1"] && LucidHack.TextEntries["Spam4"] != nil then
							local String = LucidHack.TextEntries["Spam4"]
							if LucidHack.Options["Spam_AntiAntiSpam"] then String = String.." ("..RandomShortString()..")" end
							LocalPlayer():ConCommand("say "..String)
						end
						if LucidHack.Options["Spam_Message_1"] && LucidHack.TextEntries["Spam5"] != nil then
							local String = LucidHack.TextEntries["Spam5"]
							if LucidHack.Options["Spam_AntiAntiSpam"] then String = String.." ("..RandomShortString()..")" end
							LocalPlayer():ConCommand("say "..String)
						end
	...
	AddHook( "ESP", "HUDPaint", RandomString(), function()
		if GetConVarNumber("LucidHack_Panic") == 0 then
			if LucidHack.Options["Cams_Toggle"] && LucidHack.Options["Cams_CSNoclip"] then
			...
			if LucidHack.Options["ESP_Toggle"] || LucidHack.Options["ESP_Entity_Toggle"] then
				for k, v in pairs( ents.GetAll() ) do
					if v:IsValid() && v != LocalPlayer() && !v:IsDormant() then
						local Ent = v
						if LucidHack.Options["ESP_Entity_Toggle"] then
							for k, v in pairs( LucidHack.EntityESP ) do
								if v == Ent:GetClass() && Ent:GetOwner() != LocalPlayer()  then
									local MaxX, MaxY, MinX, MinY, V1, V2, V3, V4, V5, V6, V7, V8 = ESPGetPos( Ent )
									if LucidHack.Options["ESP_Entities_NameTags"] == true then
									...
									if LucidHack.Options["ESP_Entities_BoundaryBoxes"] == true then
										surface.SetDrawColor( Color(0,160,240) )
										if LucidHack.Options["ESP_Entities_BoundaryBoxes_Mode"] == "2D" then
											surface.DrawLine( MaxX, MaxY, MinX, MaxY )
											surface.DrawLine( MaxX, MaxY, MaxX, MinY )
											surface.DrawLine( MinX, MinY, MaxX, MinY )
											surface.DrawLine( MinX, MinY, MinX, MaxY )
						...
						if LucidHack.Options["ESP_Toggle"] then
							if LucidHack.Options["ESP_Crosshair"] == true then
								local _, TeamColor = GetTeam(LocalPlayer())
								if LucidHack.Options["ESP_Crosshair_Mode"] == "Team" && Color(LucidHack.Options["ESP_Crosshair_Color_R"], LucidHack.Options["ESP_Crosshair_Color_G"], LucidHack.Options["ESP_Crosshair_Color_B"]) != TeamColor then
									LucidHack.Options["ESP_Crosshair_Color_R"] = TeamColor.r
									LucidHack.Options["ESP_Crosshair_Color_G"] = TeamColor.g
									LucidHack.Options["ESP_Crosshair_Color_B"] = TeamColor.b
								end
								surface.SetDrawColor(Color(LucidHack.Options["ESP_Crosshair_Color_R"], LucidHack.Options["ESP_Crosshair_Color_G"], LucidHack.Options["ESP_Crosshair_Color_B"], LucidHack.Options["ESP_Crosshair_Color_A"]))
								surface.DrawLine((ScrW()/2)-LucidHack.Options["ESP_Crosshair_Size"], ScrH()/2, (ScrW()/2)+LucidHack.Options["ESP_Crosshair_Size"], ScrH()/2)
								surface.DrawLine(ScrW()/2, (ScrH()/2)-LucidHack.Options["ESP_Crosshair_Size"], ScrW()/2, (ScrH()/2)+LucidHack.Options["ESP_Crosshair_Size"])
							end
							if Ent:IsNPC() || Ent:IsPlayer() then
								...
								if !Ent:IsNPC() && Ent:Health() > 0 then
									local Team, _ = GetTeam(Ent)
									if Ent:Team() != TEAM_SPECTATOR && LucidHack.Options["ESP_ShowTeam"] && Team == GetTeam(LocalPlayer()) then
										if LucidHack.Options["ESP_ShowTeamV"] == "Show" then
											ShowTeam = true
										else
											ShowTeamV = false
										end
									end
									if Ent:Team() != TEAM_SPECTATOR && LucidHack.Options["ESP_ShowOpponents"] && Team != GetTeam(LocalPlayer()) then
										if LucidHack.Options["ESP_ShowOpponentsV"] == "Show" then
											ShowOpponents = true
										else
											ShowOpponentsV = false
										end
									end
									if Ent:Team() != TEAM_SPECTATOR && LucidHack.Options["ESP_ShowFriends"] && ( (!LucidHack.Options["Friends_FriendIsEnemy"] && table.HasValue( LucidHack.FriendsList, Ent:SteamID() ) ) || (LucidHack.Options["Friends_FriendIsEnemy"] && !table.HasValue( LucidHack.FriendsList, Ent:SteamID() ) ) ) then
										if LucidHack.Options["ESP_ShowFriendsV"] == "Show" then
											ShowFriends = true
										else
											ShowFriendsV = false
										end
									end
									if Ent:Team() != TEAM_SPECTATOR && LucidHack.Options["ESP_ShowEnemies"] && ( (!LucidHack.Options["Friends_FriendIsEnemy"] && !table.HasValue( LucidHack.FriendsList, Ent:SteamID() ) ) || (LucidHack.Options["Friends_FriendIsEnemy"] && table.HasValue( LucidHack.FriendsList, Ent:SteamID() ) ) ) then
										if LucidHack.Options["ESP_ShowEnemiesV"] =="Show" then
											ShowEnemies = true
										else
											ShowEnemiesV = false
										end
									end
									if LucidHack.Options["ESP_ShowSpectators"] && Ent:Team() == TEAM_SPECTATOR then
										if LucidHack.Options["ESP_ShowSpectatorsV"] == "Show" then
											ShowSpectators = true
										else
									...
									if LucidHack.Options["ESP_ShowNPCs"] && Ent:IsNPC() then
										if LucidHack.Options["ESP_ShowNPCsV"] == "Show" then
											ShowNPCs = true
										else
											ShowNPCsV = false
										end
								...
								if (ShowTeam || ShowOpponents || ShowFriends || ShowEnemies || ShowNPCs || ShowSpectators) && (ShowTeamV && ShowOpponentsV && ShowFriendsV && ShowEnemiesV && ShowNPCsV && ShowSpectatorsV) then
									...
									if LucidHack.Options["ESP_BoundaryBoxes"] then
										surface.SetDrawColor( DrawColor )
										if LucidHack.Options["ESP_BoundaryBoxes_Mode"] == "2D" then
											surface.DrawLine( MaxX, MaxY, MinX, MaxY )
											surface.DrawLine( MaxX, MaxY, MaxX, MinY )
											surface.DrawLine( MinX, MinY, MaxX, MinY )
											surface.DrawLine( MinX, MinY, MinX, MaxY )
									...
									if LucidHack.Options["ESP_Health"] then					
									...
									if LucidHack.Options["ESP_NameTags"] then
									...
									if LucidHack.Options["ESP_Weapon"] then
	...
	AddHook( "BhopCalcView", "CalcView", RandomString(), function( ply, pos, angles, fov )
		if GetConVarNumber("LucidHack_Panic") == 0 && LucidHack.Options["Bhop_Toggle"] then
			if LucidHack.Options["Bhop_Sideways"] then
				local CamData = {}
				...
				return CamData
			elseif LucidHack.Options["Bhop_WOnly"] then
				local CamData = {}
				if WLeft then
	...
	AddHook( "Bhop", "CreateMove", RandomString(), function(ucmd)
		if LucidHack.Options["Bhop_Toggle"] && GetConVarNumber("LucidHack_Panic") == 0 then
			if LucidHack.Options["Bhop_FastWalk"] then
			...
			if LucidHack.Options["Bhop_AutoHop"] then
			...
			if LucidHack.Options["Bhop_AutoStrafe"] && !LocalPlayer():IsOnGround() && LocalPlayer():WaterLevel() <= 1 && LocalPlayer():GetMoveType() != MOVETYPE_LADDER && !( LocalPlayer():KeyDown(IN_FORWARD) || LocalPlayer():KeyDown(IN_BACK) || LocalPlayer():KeyDown(IN_MOVELEFT) || LocalPlayer():KeyDown(IN_MOVERIGHT) ) then
				if LucidHack.Options["Bhop_Sideways"] && !TapS then
			...
			if LucidHack.Options["Bhop_EdgeJump"] then
				if LocalPlayer():IsOnGround() then
					...
					local FinPos = LocalPlayer():EyePos() + (WalkAngle:Forward()*(LucidHack.Options["Bhop_EdgeJump_Distance"]-50))
	...
	AddHook( "Cams", "CalcView", RandomString(), function( ply, Pos, Ang, FOV )
		if LucidHack.Options["Cams_Toggle"] && GetConVarNumber("LucidHack_Panic") == 0 then
			local CamData = {}
			if LucidHack.Options["Cams_CSNoclip"] then
				local Speed = LucidHack.Options["Cams_CSNoclip_Speed"]/5
			...
			elseif LucidHack.Options["Cams_ThirdPerson"] then
				CamData.origin = Pos-(Ang:Forward()*(LucidHack.Options["Cams_ThirdPerson_Zoom"]*10))
				CamData.angles = Ang
				CamData.fov = FOV
				CamData.drawviewer = true
			end
	...
	AddHook( "Bhop", "CreateMove", RandomString(), function(ucmd)
		if LucidHack.Options["Cams_Toggle"] && LucidHack.Options["Cams_CSNoclip"] && GetConVarNumber("LucidHack_Panic") == 0 then
	...
	if Display then
		AddHook( "Loaded", "HUDPaint", RandomString(), function()
			draw.SimpleTextOutlined( "Lucid's Hack Loaded Successfully!", "Menu_Title", ScrW()/2, 50, Color(0,150,150), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, Color(0,0,0) )
			timer.Simple( 3, function()
				RemoveHook("Loaded")
			end)
		end)
...
function Aimbot( FinAngle )
	if LucidHack.Options["Aimbot_SmoothAim"] then
		SmoothAngles( FinAngle, LucidHack.Options["Aimbot_SmoothAim_Value"] )
	else
...
function SmoothAngles( FinAngle, SmoothValue )
	...
	if LucidHack.Options["Aimbot_AutoShoot"] && X && Y then
		LocalPlayer():ConCommand("+attack")
		timer.Simple( 0.1, function() LocalPlayer():ConCommand("-attack") end )
	end
end
...
function AddKeyBind( Parent, PosX, PosY, Var )
	...
	if LucidHack.Options["Aimbot_AimOnKey_Key"] >= 107 && LucidHack.Options["Aimbot_AimOnKey_Key"] <= 113 then
		KeyBind:SetText( LucidHack.MouseBinds[LucidHack.Options["Aimbot_AimOnKey_Key"]])
	else
		KeyBind:SetText( LucidHack.KeyBinds[LucidHack.Options["Aimbot_AimOnKey_Key"]])
	end
			...
			if !ESCStuff then
				for i = 107, 113 do
					if input.IsMouseDown(i) then
						LucidHack.Options[Var] = i
						KeyBind:SetText(LucidHack.MouseBinds[i])
						NoClickMenu:Close()
						KeyBind.Think = nil
					end
				end
				for i = 0, 159 do
					if input.IsKeyDown(i) then
						if i == 70 then
							...
							LucidHack.Options[Var] = i
							KeyBind:SetText(LucidHack.KeyBinds[i])
							NoClickMenu:Close()
							KeyBind.Think = nil
						end
					end
				...
				if input.IsKeyDown(70) then
					if ESCNum >= 200 then
						LucidHack.Options[Var] = 0
						KeyBind:SetText(LucidHack.KeyBinds[0])
						NoClickMenu:Close()
						KeyBind.Think = nil
					else ESCNum = ESCNum + 1 end
				else
					KeyBind:SetText(LucidHack.KeyBinds[LucidHack.Options[Var]])
					NoClickMenu:Close()
					KeyBind.Think = nil
				end
			end
...
function AddCheckBox( Parent, Text, PosX, PosY, ToolTip, Var, ExtraFunc )
	...
	AddCheckBox:SetChecked( LucidHack.Options[Var] )
	AddCheckBox.OnChange = function()
		LucidHack.Options[Var] = AddCheckBox:GetChecked()
...
function AddBoneButton( Parent, PosX, PosY, Bone )
	...
	if table.HasValue( LucidHack.BoneOrder, Bone ) then
		for k, v in pairs(LucidHack.BoneOrder) do
			if v == Bone then
	...
	AddBoneButton.DoRightClick = function()
		...
		if BoneNum == 0 then
			table.insert( LucidHack.BoneOrder, Bone )
		elseif BoneNum == 1 then
			table.remove( LucidHack.BoneOrder, BoneNum )
		else
			table.remove( LucidHack.BoneOrder, BoneNum )
			table.insert( LucidHack.BoneOrder, BoneNum-1, Bone )
		end
	...
	AddBoneButton.DoClick = function()
		...
		if BoneNum == 0 then
			table.insert( LucidHack.BoneOrder, 1, Bone )
		elseif BoneNum == 21 then
			table.remove( LucidHack.BoneOrder, BoneNum )
		else
			if BoneNum != table.Count( LucidHack.BoneOrder ) then
				table.remove( LucidHack.BoneOrder, BoneNum )
				table.insert( LucidHack.BoneOrder, BoneNum+1, Bone )
			else
				table.remove( LucidHack.BoneOrder, BoneNum )
...
function AddSlider( Parent, Var, PosX, PosY, Min, Max, Decimals )
	...
	AddSlider:SetValue( LucidHack.Options[Var] )
	AddSlider.OnValueChanged = function( Panel, Value )
		LucidHack.Options[Var] = math.Round( Value, Decimals )
	end
...
function AddTextEntry( Parent, Width, PosX, PosY, DefaultText, Var, Save )
	...
	if Save != nil && LucidHack.TextEntries[Var] != nil then
		AddTextEntry:SetText(LucidHack.TextEntries[Var])
	else
	...
	AddTextEntry.OnLoseFocus = function()
		if AddTextEntry:GetText() == "" then
			AddTextEntry:SetText(DefaultText)
			LucidHack.TextEntries[Var] = nil
		else
			LucidHack.TextEntries[Var] = AddTextEntry:GetText()
		end
	end
end
...
function AddDisplayBox( Title, Mode )
	...
	if Mode == 1 then
		DisplayBox:SetPos( LucidHack.Options["Misc_AdminBox_PosX"], LucidHack.Options["Misc_AdminBox_PosY"] )
		local AdminTable = {"Moo"}
		local Wait = false
		AddHook( "AdminDisplayBox", "Think", RandomString(), function()
			if !LucidHack.Options["Misc_AdminBox"] then
				DisplayBox:Close()
				RemoveHook("AdminDisplayBox")
			end
			local PoX, PoY = DisplayBox:GetPos()
			if  LucidHack.Options["Misc_AdminBox_PosX"] != PoX ||  LucidHack.Options["Misc_AdminBox_PosY"] != PoY then
				LucidHack.Options["Misc_AdminBox_PosX"], LucidHack.Options["Misc_AdminBox_PosY"] = PoX, PoY
			end
			...
			if table.concat(TempAdminTable) != table.concat(AdminTable) then
				...
				elseif Wait then
					...
					if DifferenceX < 0 then
						...
						RightPos = LucidHack.Options["Misc_"..Var.."_PosX"] - DifferenceX
					else
						RightPos = LucidHack.Options["Misc_"..Var.."_PosX"] + DifferenceX
					end
					if DifferenceY < 0 then
						DifferenceY = DifferenceY * -1
						BottomPos = LucidHack.Options["Misc_"..Var.."_PosY"] - DifferenceY
					else
						BottomPos = LucidHack.Options["Misc_"..Var.."_PosY"] + DifferenceY
					end

					if LucidHack.Options["Misc_"..Var.."_Mode"] == "Auto" then
						local PosX, PosY
						if LucidHack.Options["Misc_"..Var.."_PosX"] > ScrW()/2 then PosX = RightPos else PosX = LucidHack.Options["Misc_"..Var.."_PosX"] end
						if LucidHack.Options["Misc_"..Var.."_PosY"] > ScrH()/2 then PosY = BottomPos else PosY = LucidHack.Options["Misc_"..Var.."_PosY"] end
						DisplayBox:SetPos( PosX, PosY )
					elseif LucidHack.Options["Misc_"..Var.."_Mode"] == "Top Right" then
						DisplayBox:SetPos( RightPos, LucidHack.Options["Misc_"..Var.."_PosY"] )
					elseif LucidHack.Options["Misc_"..Var.."_Mode"] == "Bottom Left" then
						DisplayBox:SetPos( LucidHack.Options["Misc_"..Var.."_PosX"], BottomPos )
					elseif LucidHack.Options["Misc_"..Var.."_Mode"] == "Bottom Right" then
	...
	elseif Mode == 2 then
		DisplayBox:SetPos( LucidHack.Options["Misc_SpectatorsBox_PosX"], LucidHack.Options["Misc_SpectatorsBox_PosY"] )
		local SpecsTable = {"Moo"}
		local Wait = false
		AddHook( "SpecDisplayBox", "Think", RandomString(), function()
			if !LucidHack.Options["Misc_SpectatorsBox"] then
				DisplayBox:Close()
				RemoveHook("SpecDisplayBox")
			end
			local PoX, PoY = DisplayBox:GetPos()
			if  LucidHack.Options["Misc_SpectatorsBox_PosX"] != PoX ||  LucidHack.Options["Misc_SpectatorsBox_PosY"] != PoY then
				LucidHack.Options["Misc_SpectatorsBox_PosX"], LucidHack.Options["Misc_SpectatorsBox_PosY"] = PoX, PoY
			end
...
function AddSavePage( Parent, Mode )
					...
					if k != 1 && k != 2 then
						if ManageSaves:GetLine(ManageSaves:GetSelectedLine()):GetValue(2) != "This save has been corrupted" then
							if Mode == "Friends" then
								table.insert( LucidHack.FriendsList, v )
							elseif Mode == "Configs" then
								if string.Left( v, 1 ) == "{" then
									LucidHack.BoneOrder = util.JSONToTable( v )
								else
									local CommandTable = string.Explode( " ", v )
									if CommandTable[3] == "true" || CommandTable[3] == "false" then
										LucidHack.Options[CommandTable[1]] = tobool(CommandTable[3])
									elseif isnumber(tonumber(CommandTable[3])) then
										LucidHack.Options[CommandTable[1]] = tonumber(CommandTable[3])
									else
										LucidHack.Options[CommandTable[1]] = tostring(CommandTable[3])
									end
								end
							elseif Mode == "Entities" then
								table.insert( LucidHack.EntityESP, v )
							end
						end
					end
				end
	...
	AddGenericButton( Parent, "Save", 52, 20, 305, 275, function()
		if LucidHack.TextEntries[Mode] != nil then
			local Files, Dirs = file.Find( "sh/"..Mode.."/*", "DATA" )
			for k, v in pairs( Files ) do
				local Title = string.StripExtension(v)
				if Title == LucidHack.TextEntries[Mode] then return end
			end
			...
			if file.Exists( "sh/"..Mode, "DATA" ) then
				if tonumber( os.date("%H"), 10 ) < 12 then
					...
					if Mode == "Friends" then
						for k, v in pairs( LucidHack.FriendsList ) do
							SaveText = SaveText.."|"..v
						end
						file.Write( "sh/"..Mode.."/"..LucidHack.TextEntries[Mode]..".txt", SaveText)
					elseif Mode == "Configs" then
						for k, v in pairs( LucidHack.Options ) do
							SaveText = SaveText.."|"..k.." = "..tostring(v)
						end
						SaveText = SaveText.."|"..util.TableToJSON( LucidHack.BoneOrder )
						file.Write( "sh/"..Mode.."/"..LucidHack.TextEntries[Mode]..".txt", SaveText)
					elseif Mode == "Entities" then
						for k, v in pairs( LucidHack.EntityESP ) do
							SaveText = SaveText.."|"..v
	...
	AddGenericButton( Parent, "Rename", 52, 20, 305, 300, function()
		if ManageSaves:GetSelectedLine() != nil && LucidHack.TextEntries[Mode] != nil then
			local SaveTitle = ManageSaves:GetLine(ManageSaves:GetSelectedLine()):GetValue(1)
			if file.Exists( "sh/"..Mode.."/"..SaveTitle..".txt", "DATA" ) then
				local Files, Dirs = file.Find( "sh/"..Mode.."/*", "DATA" )
				for k, v in pairs( Files ) do
				...
				file.Write( "sh/"..Mode.."/"..LucidHack.TextEntries[Mode]..".txt", SaveFileText )
				RefreshSaveList(Mode, ManageSaves)
			end
		end
	end)
...
function LucidHackMenu()
	...
	function Menu:Paint( w, h )
		...
		draw.SimpleText( "Lucid's Hack", "Menu_Title", w/2, 11, Color(0,100,200), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
	...
	if GetConVarNumber("LucidHack_Panic") == 1 then
	...
	PanicButton.DoClick = function()
		if GetConVarNumber("LucidHack_Panic") == 1 then
			RunConsoleCommand("LucidHack_Panic", 0)
			PanicButton:SetText("Disable")
			PanicButton:SetColor(Color(255,0,0,255))
		else
			RunConsoleCommand("LucidHack_Panic", 1)
			PanicButton:SetText("Enable")
			PanicButton:SetColor(Color(50,200,0,255))
		end
	end
	...
	AddGenericButton( Aimbot, "Fill", 85, 30, 400, 325, function()
		for k, v in pairs(LucidHack.Bones) do
			if !table.HasValue( LucidHack.BoneOrder, v ) then
				table.insert( LucidHack.BoneOrder, v )
			end
		end
		UpdateBoneThink = true
	end)
	AddGenericButton( Aimbot, "Clear", 85, 30, 495, 325, function()
		table.Empty( LucidHack.BoneOrder )
		UpdateBoneThink = true
	end)
	...
	Mixer:SetWangs( true )
	if LucidHack.Options["ESP_Crosshair_Mode"] == "Team" then
		Mixer:SetColor( team.GetColor(LocalPlayer():Team()) )
	else
		Mixer:SetColor( Color(LucidHack.Options["ESP_Crosshair_Color_R"], LucidHack.Options["ESP_Crosshair_Color_G"], LucidHack.Options["ESP_Crosshair_Color_B"], LucidHack.Options["ESP_Crosshair_Color_A"]) )
	end
	Mixer.Think = function()
		if LucidHack.Options["ESP_Crosshair_Mode"] == "Custom" then
			LucidHack.Options["ESP_Crosshair_Color_R"] = Mixer:GetColor().r
			LucidHack.Options["ESP_Crosshair_Color_G"] = Mixer:GetColor().g
			LucidHack.Options["ESP_Crosshair_Color_B"] = Mixer:GetColor().b
		end
		LucidHack.Options["ESP_Crosshair_Color_A"] = Mixer:GetColor().a
	end
	...
	function RefreshEntsList()
		...
		for k, v in pairs( ents.GetAll() ) do
			...
			local Copy = false
			if Name != "player" then
				if !table.HasValue( LucidHack.EntityESP, Name ) then
	...
	AddGenericButton( Ents, "------->", 80, 30, 260, 167.5, function()
		if ESPOffEntsList:GetSelectedLine() != nil then
			table.insert( LucidHack.EntityESP, ESPOffEntsList:GetLine(ESPOffEntsList:GetSelectedLine()):GetValue(1) )
		end
		RefreshEntsList()
	end)
		...
		if ESPOnEntsList:GetSelectedLine() != nil then
			for k, v in pairs( LucidHack.EntityESP ) do
				if v == ESPOnEntsList:GetLine(ESPOnEntsList:GetSelectedLine()):GetValue(1) then
					table.remove( LucidHack.EntityESP, k )
				end
			end
		end
		RefreshEntsList()
	...
	AddGenericButton( Ents, "Add All", 80, 30, 260, 95, function()
		for k, v in pairs( ESPOffEntsList:GetLines() ) do
			table.insert( LucidHack.EntityESP, v:GetValue(1) )
		end
		RefreshEntsList() 
	end)
	AddGenericButton( Ents, "Clear Ents", 80, 30, 260, 280, function() table.Empty( LucidHack.EntityESP ) RefreshEntsList() end )
	...
	AddCheckBox( Misc, "Clock Speed Manipulator", 15, 45, "Speed hack", "Misc_Clock", function()
		if LucidHack.Options["Misc_Clock"] then
	...
	function RefreshFriendsList()
		...
		for k, v in pairs(player.GetAll()) do
			if v != LocalPlayer() then
				if LucidHack.Options["Friends_SteamFriends"] && v:GetFriendStatus() == "friend" then
					if !table.HasValue(LucidHack.FriendsList, v:SteamID()) then table.insert(LucidHack.FriendsList, v:SteamID()) end
				end
				if LucidHack.Options["Friends_SteamEnemies"] && v:GetFriendStatus() == "friend" then
					local PlayerSteamID = v:SteamID()
					for k, v in pairs(LucidHack.FriendsList) do
						if v == PlayerSteamID then
							table.remove(LucidHack.FriendsList, k)
						end
					end
					if table.HasValue(LucidHack.FriendsList, v:SteamID()) then table.remove(LucidHack.FriendsList, v:SteamID()) end
				end
				if LucidHack.Options["Friends_FriendIsEnemy"] then
					if table.HasValue(LucidHack.FriendsList, v:SteamID()) then
	...
	AddMainMenuButton( Friends, "Remove Friend", 112.5, 260, function()
		...
		if SelectedLine != nil then
			...
			if LucidHack.Options["Friends_FriendIsEnemy"] then
				table.insert(LucidHack.FriendsList, PlayerSteamID)
			else
				for k, v in pairs(LucidHack.FriendsList) do
					if v == PlayerSteamID then
						table.remove(LucidHack.FriendsList, k)
	...
	AddMainMenuButton( Friends, "Clear Friends", 387.5, 300, function() table.Empty( LucidHack.FriendsList ) RefreshFriendsList() end )
	...
	if LucidHack.ActiveTab == nil then LucidHack.ActiveTab = 1 end
	if LucidHack.ActiveTab == 1 then ChangeTab( Main, 1 )
	elseif LucidHack.ActiveTab == 2 then ChangeTab( Aimbot, 2 )
	elseif LucidHack.ActiveTab == 3 then ChangeTab( ESP, 3 )
	elseif LucidHack.ActiveTab == 4 then ChangeTab( Ents, 4 )
	elseif LucidHack.ActiveTab == 5 then ChangeTab( Misc, 5 )
	elseif LucidHack.ActiveTab == 6 then ChangeTab( Friends, 6 )
	elseif LucidHack.ActiveTab == 7 then ChangeTab( Cams, 7 )
	elseif LucidHack.ActiveTab == 8 then ChangeTab( Bhop, 8 )
	elseif LucidHack.ActiveTab == 9 then ChangeTab( Spam, 9 )
	elseif LucidHack.ActiveTab == 10 then ChangeTab( Test10, 10 )
	elseif LucidHack.ActiveTab == 11 then ChangeTab( Test11, 11 )
	elseif LucidHack.ActiveTab == 12 then ChangeTab( Config, 12 )
	elseif LucidHack.ActiveTab == 13 then ChangeTab ( FriendSaves, 13 )
	elseif LucidHack.ActiveTab == 14 then ChangeTab ( EntitySaves, 14 )
	elseif LucidHack.ActiveTab == 15 then ChangeTab ( CustomCrosshair, 15 ) end
